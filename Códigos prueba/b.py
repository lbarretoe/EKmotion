...
class ECGApp:
    def __init__(self, master):
        ...
        self.plot_frame.grid(row=0, column=0)  # Modificado aquí

        # Frame para los botones
        self.button_frame = tk.Frame(master)
        self.button_frame.grid(row=0, column=1)  # Modificado aquí
        ...
        self.start_button.pack(side=tk.TOP)  # Modificado aquí

        self.stop_button = tk.Button(self.button_frame, text="Parar grabación", command=self.stop_recording)
        self.stop_button.pack(side=tk.TOP)  # Modificado aquí
